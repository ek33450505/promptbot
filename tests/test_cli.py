...
class CliTests(unittest.TestCase):
    ...
    def test_interactive_copy_flow(
        ...
        self.assertIn("Session Setup", result.output)
        self.assertIn("Promptbot converts rough ideas into precise, LLM-ready prompts.", result.output)
        self.assertIn("llm-ready prompt optimization online", result.output)
        self.assertIn("Original Prompt", result.output)
        self.assertIn("Copied to clipboard.", result.output)
        mock_copy.assert_called_once()
